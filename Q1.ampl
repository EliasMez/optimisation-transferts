...
var transfert {PARTICIPANTS, PARTICIPANTS} >=0;
var paye {PARTICIPANTS} >=0;
var recu {PARTICIPANTS} >=0;
...
# Contrainte qui permet de s'assurer que chaque participant paye exactement le cout moyen
subject to equite {p in PARTICIPANTS} :
	avance [p] + paye [p] - recu [p] = montantMoyen;
